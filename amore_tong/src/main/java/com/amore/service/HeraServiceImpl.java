...
@Service("heraServiceImpl")
public class HeraServiceImpl implements ListExecuteService {
	...
	public String Execute(HttpServletRequest request) throws Exception {
		...
		System.out.println("[SVC] =========== HeraServiceImpl.excute() 시작!! ===========");
		...
		if(evt_code.equals("130308")
				
				||evt_code.equals("130103")	// amore에서 130103 을 찾을수 없음
				||evt_code.equals("130128")	// amore에서 ~~~~
				)
		{
			Other = "";
		}
