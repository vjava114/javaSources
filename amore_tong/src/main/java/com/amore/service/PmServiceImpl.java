...
public class PmServiceImpl implements ListExecuteService {
	...
	public String Execute(HttpServletRequest request) throws Exception {
		...
		System.out.println("[SVC] =========== PmServiceImpl.excute() 시작!! ===========");
	...
	//	brand = "pm";				// 여기를 해당 브랜드에 맞게 고쳐주세
		...
		if(evt_code.equals("130131")
				||evt_code.equals("130401")
				||evt_code.equals("130430")
				)
		{
			Other = "";
		}
