...
public interface MembCardlistMapper {
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table memb_cardlist
     *
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    int countByExample(MembCardlistExample example);
     ...
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    int deleteByExample(MembCardlistExample example);
     ...
     */
    @Delete({
        "delete from memb_cardlist",
        "where memb_id = #{membId,jdbcType=VARCHAR}"
    })
    int deleteByPrimaryKey(String membId);
    ...
    int insert(MembCardlist record);
     ...
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    int insertSelective(MembCardlist record);
     ...
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    List<MembCardlist> selectByExample(MembCardlistExample example);
    ...
    MembCardlist selectByPrimaryKey(String membId);
     ...
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    int updateByExampleSelective(@Param("record") MembCardlist record, @Param("example") MembCardlistExample example);
     ...
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    int updateByExample(@Param("record") MembCardlist record, @Param("example") MembCardlistExample example);
     ...
     * @mbggenerated Thu Sep 13 10:27:53 KST 2012
     */
    int updateByPrimaryKeySelective(MembCardlist record);
    ...
    int updateByPrimaryKey(MembCardlist record);
}